...
namespace UnderworldEngine.Scripting
{
    ...
    public class GameConsole : DrawableGameComponent, IGameConsole
    {
        ...
        public static void Initialize(Microsoft.Xna.Framework.Game game, string font, Color textColor,
        ...
        /// <param name="lineCount">The maximum number of text lines visible in
        /// the console at any given time</param>
        internal GameConsole(Microsoft.Xna.Framework.Game game, string font, Color textColor, 
        ...
        protected override void LoadContent()
        {
            ...
            mFont = Game.Content.Load<SpriteFont>(mFontName);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            foreach (Keys key in kb.GetPressedKeys())
            {
                ...
                {
                    mCurrentText.Insert(mInputPosition, ch);
                    mInputPosition++;
                }
            }
